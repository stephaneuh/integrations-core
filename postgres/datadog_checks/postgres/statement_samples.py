...
from datadog_checks.base.utils.db.statement_samples import default_encoding
...
class PostgresStatementSamples(object):
    ...
    def _collect_statement_samples(self):
        ...
        submitted_count = 0
        for e in events:
            self._check.database_monitoring_query_sample(json.dumps(e, default=default_encoding))
            submitted_count += 1
